...
$opt_help          = 0;
$opt_log           = undef();
$opt_mysqladmin    = "C:/Program Files (x86)/MySQL/bin/mariadb-admin";
...
[mysqld_multi]
mysqld     = C:/Program Files (x86)/MySQL/bin/mariadbd-safe
mysqladmin = C:/Program Files (x86)/MySQL/bin/mariadb-admin
user       = multi_admin
